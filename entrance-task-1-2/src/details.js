...
export function getDetailsContentLayout(ymaps) {
    const BalloonContentLayout = ymaps.templateLayoutFactory.createClass(
        ...
        {% if (properties.details) %}
            <div class="details-info">
                <div class="details-label">base station ({{properties.coordinates}})</div> 
            ...
            <div class="details-info">
                ...
                <canvas class="details-chart"  width="600" height="300"/>
            </div>
        {% else %}
            <div class="details-info">
    ...
    `
        ,
        {
            build: function () {                                //вместо стрелочной нужна обычная функция(из-за this)
